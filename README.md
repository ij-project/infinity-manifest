...
1. Initialize your local repository:
    ```bash
    repo init --no-repo-verify --git-lfs -u https://github.com/ij-project/infinity-manifest -b 16-QPR0 -g default,-mips,-darwin,-notdefault
    ```
...
# Example Defintions
ro.product.marketname=Realme X
ro.infinity.soc=Snapdragon sdm710
